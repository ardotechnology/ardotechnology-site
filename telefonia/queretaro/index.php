...
$seoConfig = SeoHelper::load('landing-queretaro');
$basePath = '../../';

// Define custom head content for specific SEO tags for this landing page
$customHead = '<meta name="geo.region" content="MX-QUE" />
...
<?php include $basePath . 'includes/partners-bottom.php'; ?>

<?php include $basePath . 'includes/contact.php'; ?>
